...
//    imu.wz   = mpu_data.gz / 16.384f / 57.3f;
		imu.gx   = mpu_data.gx / 16.384f ; 
    imu.gy   = mpu_data.gy / 16.384f ; 
    imu.gz   = mpu_data.gz / 16.384f ;
		/* 1000dps -> rad/s */
//		imu.wx   = mpu_data.gx / 32.768f / 57.3f; 
//    imu.wy   = mpu_data.gy / 32.768f / 57.3f; 
//    imu.wz   = mpu_data.gz / 32.768f / 57.3f;
//				imu.wx=MPU_LPF(mpu_data.gx,
//                        &Gyro_BufferData[0],
//                        &Gyro_Parameter
//                        );
//        imu.wy=MPU_LPF(mpu_data.gy,
//                        &Gyro_BufferData[1],
//                        &Gyro_Parameter
//                        );
//        imu.wz=MPU_LPF(mpu_data.gz,
//                        &Gyro_BufferData[2],
//                        &Gyro_Parameter
//                        );
//			imu.wx   = imu.wx / 32.768f / 57.3f; 
//		  imu.wy   = imu.wy / 32.768f / 57.3f; 
//		  imu.wz   = imu.wz / 32.768f / 57.3f;
			
//			imu.wx   = mpu_data.gx / 32.768f / 57.3f; 
//		  imu.wy   = mpu_data.gx / 32.768f / 57.3f; 
//		  imu.wz   = mpu_data.gx / 32.768f / 57.3f;
}
...
uint8_t mpu_device_init(void)
{
	...
	uint8_t MPU6500_Init_Data[10][2] = {{ MPU6500_PWR_MGMT_1, 0x80 },     /* Reset Device */ 
																			...
																			{ MPU6500_GYRO_CONFIG, 0x11 },    /* +-2000dps */ 
